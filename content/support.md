...
I read every message and usually reply within 1 business day (Slovenia time).

## What to include

To help us help you faster, please tell us:

- What you were trying to do
- What happened instead
- Your device (e.g. iPhone 15 Pro, Pixel 8)
- Your OS version (e.g. iOS 18.2, Android 14)
- The Lansia version and build number (Settings → scroll to bottom)

If something went visibly wrong on screen, a screenshot is the single most useful thing you can send.

## Common questions

**I lost my Lifetime Access after reinstalling the app.**
...
Both welcome. Same email, same inbox.

## Privacy and data

If you want a copy of your data, or have any privacy-related question, write to the same address and mention "privacy" in the subject.
